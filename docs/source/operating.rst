...
.. important::
   ...
   **not be valid if your [three-7042] container is NOT running**.

.. tip::
   You must have your [three-7042] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39121  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='hardikdagar7'  \-\-env DOCKERUSERNAME='hardikdagar0207'  \-\-env MQTTUSERNAME='hardikdagar0207'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   hardikdagar0207/three-7042-amd64 (https://hub.docker.com/r/hardikdagar0207/three-7042-amd64)
...
.. code-block::
   ...
   docker run -d -p 34237:34237 -p 48603:48603 -p 38955:38955 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=three-7042 \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-three-7042 \
          --env GITUSERNAME=hardikdagar7 \
          --env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git \
          --env SOLUTIONEXTERNALPORT=34237 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=48603  \
          --env SOLUTIONVIPERVIZPORT=38955 \
          ...
          hardikdagar0207/three-7042-amd64
...
[three-7042] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/hardikdagar7/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/three-7042
...
.. important::
   https://three-7042.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-three-7042
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=34237, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=35851, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=32909, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34719, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33777, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=44375, HPDEHOST=127.0.1.1, HPDEPORT=46685, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=46657

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4564-three-7042,solution_preprocessing_ai_mqtt_dag-three-7042, python-preprocess-6717-three-7042,solution_preprocessing_ai_mqtt_dag-three-7042, python-ai-6885-three-7042,solution_preprocessing_ai_mqtt_dag-three-7042, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
